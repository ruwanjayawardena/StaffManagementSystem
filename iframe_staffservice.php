...
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-edit"></i> <span class="stf_name_initial"></span> Service</h4>                       
                    </div>
                </div>
                <div class="row mb-4 pl-2 pr-2 bg-light">					
						...
						<div class="row">							
							...
							<div class="col">
								...
								<div class="form-row">
									<div class="col">
										<div class="form-group">
											<label for="sev_ap_pre_sevdate">Applicant Date to Present Service</label>
											<input type="text" class="form-control datepicker" id="sev_ap_pre_sevdate" placeholder="Applicant Date to Present Service" autocomplete="off" required>
											<div class="valid-feedback">
												<i class="fas fa-lg fa-check-circle"></i> Looks good! 
											</div>
											<div class="invalid-feedback">
												<i class="fas fa-lg fa-exclamation-circle"></i> Please enter Applicant Date to Present Service
											</div>
										</div>  
									</div> 
									<div class="col">
                            ...
                            <table id="tblService" class="table table-bordered table-hover" style="width:100%">
                                <thead class="thead-dark">
                                    <tr>
										...
										<th>Location</th>                                       
										<th>Description</th>
										<th>Present Service Date</th>
										<th>Present Service File No</th>
									</tr>									
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <script>
		function tblService(callback) {
			...
			$.post('controllers/staffController.php', {action: 'getAllServiceByStaffID', stf_id: stf_id}, function (e) {
				...
				$('.btn_select').click(function () {
					...
					$.post('controllers/staffController.php', {action: 'getServiceByID', sev_id: sev_id}, function (e) {
						$.each(e, function (index, qdt) {
							...
							cmbZonal(qdt.prov_id,qdt.sev_zonal);
							cmbBranch(qdt.sev_zonal, qdt.sev_branch);
							cmbDivision(qdt.sev_zonal, qdt.sev_division);
							cmbInstituteWithoutType(qdt.sev_division, qdt.sev_institute)
				...
				$('.btn_eb').click(function () {
					...
					var sev_sv = sevAr[1];
					var stf_id = $('#stf_id').val();
					window.location.href = 'iframe_ebexam.php?stf_id=' + stf_id + '&sev_id=' + sev_id + '&sev_sv=' + sev_sv;
				})
		...
		$(document).ready(function () {
			...
			cmbProvince(false, function () {
				...
				cmbZonal(inst_province, false, function (dataAvailable) {
					...
					cmbDivision(inst_zonal, false, function (dataAvailable) {
						...
						cmbInstituteWithoutTypeWithoutType(inst_division);
					});
				});
			});
			...
			cmbZonal(false, function (dataAvailable) {
				validateForm(dataAvailable);
				var inst_zonal = $('.cmbZonal').val();
				cmbBranch(inst_zonal, false, function (dataAvailable) {
					validateForm(dataAvailable);
